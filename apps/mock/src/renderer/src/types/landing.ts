...
export type ModelStatus = "not_installed" | "downloading" | "ready";
...
export const AVAILABLE_LORAS: LoraAdapter[] = [
	...
	},
	{
		...
		baseTargetId: "openrouter-poolside",
		revision: "r3",
		digest: "sha256:e991…02b",
		status: "ready",
		scope: "remote",
		summary: "Same adapter identity on OpenRouter Poolside — usage tracked"
	}
];
...
export const EXECUTION_TARGETS: ExecutionTargetOption[] = [
	{
		id: "local-laguna",
		label: "synth/Laguna-XS-2.1-NVFP4",
		description: "Local · MLX · Metal · usage tracked",
		group: "local"
	},
	{
		id: "openrouter-poolside",
		label: "openrouter/poolside/laguna-s-2.1",
		description: "OpenRouter · Codex/ACP · usage tracked",
		group: "remote"
	},
	{
		id: "openrouter-luna",
		label: "openrouter/openai/gpt-5.6-luna",
		description: "OpenRouter · remote · usage tracked",
		group: "remote"
	},
	{
		id: "intern-sync",
		label: "Intern · Live session",
		description: "Synth Cloud · sync",
		group: "cloud"
	},
	{
		id: "intern-async",
