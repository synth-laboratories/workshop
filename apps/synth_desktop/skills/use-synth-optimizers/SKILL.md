...
2. Choose the algorithm from the user's objective:
   - GEPA: improve prompts or other candidate values. Read [references/gepa.md](references/gepa.md).
   - GELO / Go-Ex: explore a hosted search space or reconcile an existing hosted run. Read [references/gelo.md](references/gelo.md).
   - SFT: train and compare model weights/checkpoints. Read [references/sft.md](references/sft.md).
