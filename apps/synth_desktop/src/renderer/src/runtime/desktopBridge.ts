...
window.synthWorkspaceScope ??= isTauri
	...
	window.synthModelPerformance ??= isTauri?{summaries:()=>invoke<ModelPerformanceSummary[]>("model_performance_summary")}:{summaries:async()=>[]};
