...
function ActivityLine({
	...
	if (/approval requested/i.test(line.label)) {
		return (
			<div className="approval-card" data-testid={`approval-${line.id}`}>
				...
				<div className="approval-card-actions">
					<button type="button" className="approval-reject" onClick={onReject}>Reject</button>
					<button type="button" className="approval-approve" onClick={onApprove}>Approve</button>
				</div>
			</div>
		);
	}
...
export function ChatTranscript({ chat, openArtifactId, onOpenArtifact, onApprove, onReject }: Props) {
