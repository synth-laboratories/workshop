...
test("the settings button deep-links without duplicative rail commentary", () => {
	...
	assert.doesNotMatch(app, /Owns local model memory, prompt caches, and the single-GPU queue\./);
});
