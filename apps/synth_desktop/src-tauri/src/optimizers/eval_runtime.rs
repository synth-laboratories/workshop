...
//!
//! Eval is not a second Python distribution. It consumes the same 0.2.17
...
mod tests {
    ...
    #[test]
    fn pinned_eval_runtime_is_managed_at_0_2_17() {
    ...
    fn manifest_round_trip_retains_digest_and_python() {
        ...
        let sidecar = OptimizerSidecarVersion {
            ...
            algorithm_version: "synth-optimizers-0.2.17".into(),
        ...
        assert_eq!(manifest.version, "0.2.17");
