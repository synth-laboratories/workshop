...
export function Shell(props: ShellProps) {
  ...
  const [view, setView] = useVisualState<ViewId>("annotation.view", "overview");
  const [selectedFinding, setSelectedFinding] = useVisualState<string | null>("annotation.selectedFinding", null);
  const [selectedSpan, setSelectedSpan] = useVisualState<string | null>("annotation.selectedSpan", null);
  const [labelFilter, setLabelFilter] = useVisualState<string | null>("annotation.labelFilter", null);
