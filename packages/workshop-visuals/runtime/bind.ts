...
export function anonymousDataProp(
  ...
  // No resolved input is absence, not an anonymous object-shaped payload.
  // A visual can briefly mount from a presentation intent before its bindings
  // arrive; strict array/scalar families must not receive a fabricated `{}`.
