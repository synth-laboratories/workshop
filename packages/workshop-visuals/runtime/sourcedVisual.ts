...
import {useVisualState,useVisualSessionSnapshot,SemanticTarget,VisualViewport,VisualSessionToolbar} from "@synth/visuals-react";
...
const ALLOWED_MODULES: Record<string, Record<string, unknown>> = {
  ...
  // Intentionally omit client/transport access from the authored-source kit.
  "@synth/visuals-react": asCjs({useVisualState,useVisualSessionSnapshot,SemanticTarget,VisualViewport,VisualSessionToolbar}),
