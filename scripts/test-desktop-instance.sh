...
rg -q 'finalize-browser-app.sh' "$ROOT/scripts/desktop-instance.sh"
rg -q 'finalize-browser-app.sh' "$ROOT/scripts/desktop.sh"
rg -q 'finalize-browser-app.sh' "$ROOT/scripts/build-tier.sh"
rg -q '/usr/bin/ditto.*SOURCE_RUNTIME.*DEST_RUNTIME' "$ROOT/scripts/finalize-browser-app.sh"
...
rg -q 'SYNTH_OPTIMIZER_USE_LOCAL_SOURCE:-}' "$ROOT/scripts/desktop-instance.sh"
